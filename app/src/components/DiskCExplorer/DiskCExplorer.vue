<template>
  <div class="flex flex-col h-full animate-fade-in relative" @click="closeContextMenu" @contextmenu="closeContextMenu">
    ...
    <div v-if="view === 'root'" class="flex flex-wrap gap-6 p-2">
      <div 
        ...
        @dblclick="$emit('navigate', 'disco-c-repos')"
      >
    ...
    <div v-else-if="view === 'repos'" class="flex flex-wrap gap-6 p-2 content-start">
...
const { projects, isLoading, loadProjects } = useDiskCExplorer();
