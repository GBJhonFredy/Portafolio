<template>
  <div class="absolute inset-0 pointer-events-none z-22">
    <div
      class="window-pop bg-[#192438] p-[3px] shadow-[0_10px_30px_rgba(0,0,0,0.8)] pointer-events-auto rounded-t-xl rounded-b-md flex flex-col overflow-hidden "
      :style="windowStyle"
    > 
      <!-- Title Bar -->
      <div
      ...
      >
        <div class="flex items-center gap-2">
          ...
          <span class="text-[11px] md:text-xs font-semibold tracking-wide text-white drop-shadow-[1px_1px_1px_rgba(0,0,0,0.5)]">
      ...
      <div class="flex-1 bg-[#ece9d8] overflow-hidden  flex flex-col">
        <div class="bg-[#192438] h-full   flex flex-col overflow-hidden  shadow-inner relative text-slate-100">
          <!-- Main Body -->
          <div
          ...
          >
            ...
            <div class="w-full md:w-64 wmp-track-list flex flex-col h-48 md:h-auto">
              ...
              <div class="flex-1 overflow-auto py-1">
                ...
                <svg v-if="isCurrentTrack(track) && isWmpPlaying" viewBox="0 0 24 24" class="w-2.5 h-2.5 fill-current"><path d="M8 5v14l11-7z"/></svg>
...
// Función para limpiar y cerrar el reproductor
const onCloseWindow = () => {
  cleanupWmpAudio(); // Destruye y limpia el audio por completo
  emit('close'); // Avisa al escritorio para que desmonte la ventana
};
